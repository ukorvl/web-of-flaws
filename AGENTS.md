...
- Quote YAML frontmatter string values whenever they contain `:`, `#`, leading special characters, or other parser-sensitive content. In particular, quote `title` values like `javascript:` examples so they remain valid for strict YAML parsers.
