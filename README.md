...
- Rule guides carry stable IDs, standards mappings, detection metadata, references, kind, tags and severity. This data is stored in YAML frontmatter at the top of each guide to help agents work with the rules programmatically.
