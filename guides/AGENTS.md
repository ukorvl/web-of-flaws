...
- Use authoritative reference domains only. After changing referenced domains, run
  `python3 scripts/sync_reference_domains.py`, then review every generated allowlist change for the
  correct scope and a clear purpose.
...
`python3 scripts/sync_guide_labels.py`. After changing standards or referenced domains, run
`python3 scripts/validate_standards.py` or `python3 scripts/sync_reference_domains.py`, respectively.
